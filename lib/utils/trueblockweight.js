...
class TrueBlockWeight {
  ...
  async generatePayouts () {
    try {
      ...
      this.__generateShares(votersPerForgedBlock, forgedBlocks, latestPayoutsTimeStamp)
  ...
  **/
  ...
  __generateShares (votersPerForgedBlock, forgedBlocks, latestPayoutsTimeStamp) {
    try {
