...
class TrueBlockWeight {
  ...
  async generatePayouts () {
    try {
      ...
      const {votersPerForgedBlock, voters, currentVoters} = await this.__getVoters(delegatePublicKey, forgedBlocks, currentVotersFromAPI)
  ...
  **/
  ...
  async __getVoters (delegatePublicKey, forgedBlocks, currentVotersFromAPI) {
    try {
      ...
      return {votersPerForgedBlock, voters, currentVoters}
    } catch (error) {
