...
class TrueBlockWeight {
  ...
  async generatePayouts () {
    try {
      ...
      this.__processBalances(forgedBlocks, voterBalances, transactions)
  ...
  **/
  ...
  __processBalances (forgedBlocks, voterBalances, transactions) {
    try {
      ...
      votersBalancePerForgedBlock.forEach((votersDuringBlock, height) => {
        ...
        __voters = this.__mutateVotersBalances(height, previousHeight, __voters, transactions)
        previousHeight = height
  ...
  __mutateVotersBalances (height, previousHeight, votersBalancePerForgedBlock, transactions) {
    try {
