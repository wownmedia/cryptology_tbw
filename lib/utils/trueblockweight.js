...
if(address === 'AJQCNzjvt2zZXYeZ2zpU8g3CVvupVWntXN') {
  ...
  console.log(`${address} has ${voterBalance.div(ARKTOSHI).toFixed()} BALANCE. Gets ${rewardShare.div(ARKTOSHI).toFixed()} FROM ${height}. PENDING ${pendingPayout.div(ARKTOSHI).toFixed()}`)
}
